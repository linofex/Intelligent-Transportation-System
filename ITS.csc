...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/TL1/TL1.c</source>
      <commands EXPORT="discard">make TL1.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/TL1/TL1.sky</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/G2/G2.c</source>
      <commands EXPORT="discard">make G2.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/G2/G2.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/TL2/TL2.c</source>
      <commands EXPORT="discard">make TL2.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/TL2/TL2.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/G1/G1.c</source>
      <commands EXPORT="discard">make G1.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/G1/G1.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>14.29114010798629</x>
        <y>59.94731290411098</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>34.90071733672728</x>
        <y>45.90627589315376</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>49.33889619432761</x>
        <y>53.26126291173327</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>7.803323524616626</x>
        <y>80.40766915069716</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.6501637992359095 0.0 0.0 2.6501637992359095 141.43116843474309 30.123677753056114</viewport>
    </plugin_config>
    <width>400</width>
    <z>9</z>
    <height>400</height>
